...
@InputType()
class SubscriptionCreateNestedManyWithoutBicyclesInput {
...
export { SubscriptionCreateNestedManyWithoutBicyclesInput as SubscriptionCreateNestedManyWithoutBicyclesInput };
