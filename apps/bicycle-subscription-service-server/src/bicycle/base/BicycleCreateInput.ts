...
class BicycleCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => SubscriptionCreateNestedManyWithoutBicyclesInput,
  })
  @ValidateNested()
  @Type(() => SubscriptionCreateNestedManyWithoutBicyclesInput)
  @IsOptional()
  @Field(() => SubscriptionCreateNestedManyWithoutBicyclesInput, {
    nullable: true,
  })
  subscriptions?: SubscriptionCreateNestedManyWithoutBicyclesInput;
}

export { BicycleCreateInput as BicycleCreateInput };
